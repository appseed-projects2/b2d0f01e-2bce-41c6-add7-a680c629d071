...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-09 18:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b2d0f01e-2bce-41c6-add7-a680c629d071.git
$ cd b2d0f01e-2bce-41c6-add7-a680c629d071
```
